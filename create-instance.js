...
export default async function createInstance(provider, name, { project, region, zone, machine, image, script, tags, staticIpAddress }) {
  ...
  if (!response.ok) {
    ...
    else throw new Error(`Failed to create instance: ${JSON.stringify(info, null, 2)}`)
  }
